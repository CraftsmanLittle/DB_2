...
class Goods(models.Model):
    ...
    goods_price1 =  models.FloatField(default=80)
...
class Shopping_cart(models.Model):
    ...
    amount = models.IntegerField()
    price = models.FloatField(default="80")
...
class Activity(models.Model):
    ...
    #活动的折扣
    pecent = models.FloatField(default="1")
...
class IMG(models.Model):
    image_id = models.BigAutoField(default=1, primary_key=True)
